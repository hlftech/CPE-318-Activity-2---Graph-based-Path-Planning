...
from Grassfire import Grassfire #Initialize grid rows, columns, and obstacle probability
rows = int(input("Number of Rows:"))
cols = int(input("Number of Columns:"))
obstProb = float(input("Obstacle Range: 0 to 0.99:")) # Instantiate Grassfire class. Initialize a grid and colorGrid.
Grassfire = Grassfire()
